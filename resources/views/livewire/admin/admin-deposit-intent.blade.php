                            ...
                            <table class="min-w-full">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    @forelse ($depositIntents as $depositIntent)
                                        <tr wire:key="deposit-intent-{{ $depositIntent['id'] }}"
                                            x-data="{ isActionDropdownOpen: false }">
                                            <td class="py-3 pr-5 whitespace-nowrap sm:pr-5">
                                                <div class="flex items-center">
                                                    <p
                                                        class="text-theme-sm block font-medium text-gray-700 dark:text-gray-400">
                                                        {{ $depositIntent['user']['name'] }}
                                                    </p>
                                                </div>
                                            </td>
                                            ...
                                            <td class="px-5 py-3 whitespace-nowrap sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="text-theme-sm text-gray-700 dark:text-gray-400">
                                                        @money($depositIntent['amount'] / 100)
                                                    </p>
                                                </div>
                                            </td>
                                            <td class="px-5 py-3 whitespace-nowrap sm:px-6">
