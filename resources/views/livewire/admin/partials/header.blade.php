    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="#" class="lg:hidden">
                <img class="w-12" src="{{ asset('wp-content/uploads/2023/05/txwai.png') }}" alt="Logo" />
            </a>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="{{ asset('assets/admin/src/images/user/owner.jpg') }}" alt="User" />
                    </span>
                ...
                <div x-show="dropdownOpen"
                    class="shadow-theme-lg dark:bg-gray-dark absolute left-0 lg:left-auto lg:right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800">
                    <div>
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="w-full">
                        @csrf
                        <button type="submit"
                            class="group cursor-pointer text-theme-sm w-full mt-3 flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
