                    ...
                    <div class="w-full flex flex-col bg-dashboard rounded-xl pointer-events-auto">
                        ...
                        <div class="p-4 overflow-y-auto">
                            ...
                            <div class="mt-4 text-white text-sm">
                                Feel free to contact us if you need any help with using the Txwai Robot.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex-1">
                        ...
                        <div class="grid grid-cols-2 gap-x-2">
                            <label for="hs-vertical-radio-in-form-demo"
                                ...
                                class="px-4 py-2 w-full {{ $this->accountTypeSlug === 'demo' ? 'border-3 border-[#1F4ED8]' : 'border border-[#323335]' }} bg-transparent rounded-lg text-base focus:border-[#1a1b20] focus:ring-[#1a1b20]">
                            ...
                            <label for="hs-vertical-radio-in-form-live"
                                ...
                                class="px-4 py-2 w-full {{ $this->accountTypeSlug === 'live' ? 'border-3 border-[#1F4ED8]' : 'border border-[#323335]' }} bg-transparent rounded-lg text-base focus:border-[#1a1b20] focus:ring-[#1a1b20]">
                        ...
                        <div
                            ...
                            <div class="p-4 overflow-y-auto">
                                ...
                                <div class="text-center mb-4">
                                    <h1 class="text-white font-bold text-xl">Download Txwai App</h1>
                                </div>
