                    ...
                    <div class="mb-4">
                        <div class="flex items-center gap-x-1 mb-2">
                            <label for="file-upload" class="text-sm font-semibold text-white">Upload Payment
                                Screenshot</label>
                            <svg x-show="uploadError" x-cloak width="14" height="14" viewBox="0 0 14 14"
                            ...
                            <div class="flex items-center gap-x-1">
                                <div>
                                    <label for="file-upload"
                                        class="inline-flex items-center gap-x-1 bg-[#1F4ED8] text-black font-semibold text-xs py-1 px-2 rounded-lg cursor-pointer">
                                        <div class="-mt-0.5">
