            ...
            <div class="px-8 flex items-center justify-center h-full">
                <div class="max-w-sm mx-auto p-6 pb-8 bg-dim rounded-2xl text-center border border-[#26252a]">
                    ...
                    <div class="flex items-center justify-center gap-x-2 my-4">
                        <div class="flex-none">
                            <div
                                class="flex items-center justify-center w-fit gap-x-2 px-4 py-2 bg-dim rounded-full border border-[#26252a]">
                                <div class="flex-none mt-0.5">
                                    <div class="rounded-full size-1.5 bg-green-500"></div>
                                </div>
                                {{-- <div class="flex-none mt-0.5">
                                    <p class="text-xs text-white font-bold">Connected</p>
                                </div> --}}
                                <div class="flex-none">
                        ...
                        <div class="flex-none">
                            <div
                                class="flex items-center justify-center gap-x-2 w-fit px-4 py-2 bg-dim rounded-full border border-[#26252a]">
                                <div class="flex-none mt-0.5">
                                    <div class="rounded-full size-1.5 bg-green-500"></div>
                                </div>
                                {{-- <div class="flex-none mt-0.5">
                                ...
                                <div class="flex-none -mt-0.5">
                                    <img class="inline w-14" src="{{ asset('assets/icons/binance.svg') }}"
                                        alt="binance-logo">
                                </div>
                                <div class="flex-none mt-0.5">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                    ...
                    <div class="text-center">
                        <p class="text-xs leading-5 text-[#a4a4a4]">All trading accounts on our platform are
                            ...
                            <img class="inline w-14 align-middle" src="{{ asset('assets/icons/binance.svg') }}"
                                alt="binance-logo">(via API) and
                            <img class="inline align-middle" src="{{ asset('assets/icons/xtb.svg') }}"
                                alt="xtb-logo">(via <img class="inline-block -mt-0.5 w-4"
