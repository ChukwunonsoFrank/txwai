    ...
    <div class="lg:flex lg:h-full">
        ...
        <div class="lg:h-full lg:flex-1 lg:pl-6 lg:pr-4">
            <div class="my-3 sticky top-0 bg-dashboard pb-2 lg:pt-4">
                <h1 class="text-white text-lg md:text-xl lg:text-2xl font-semibold">FAQs</h1>
            </div>
            <div class="lg:h-full lg:pb-24 lg:overflow-scroll scrollbar-hide">
                <div class="hs-accordion-group">
                    <div class="hs-accordion border-2 border-[#26252a] active"
                        ...
                        <div id="hs-basic-with-title-and-arrow-stretched-collapse-one"
                            ...
                            <p class="text-white text-sm">
                                Txwai is an automated Ai trading bot that helps you trade the forex and crypto
                    ...
                    <div class="hs-accordion border-2 border-[#26252a]"
                        ...
                        <div id="hs-basic-with-title-and-arrow-stretched-collapse-two"
                            ...
                            <p class="text-white text-sm">
                                ...
                                Txwai with zero knowledge in trading. The Ai bot handles all the trades for you
                    ...
                    <div class="hs-accordion border-2 border-[#26252a]"
                        ...
                        <div id="hs-basic-with-title-and-arrow-stretched-collapse-three"
                            ...
                            <p class="text-white text-sm">
                                Txwai does not charge any hidden fees. However, there’s a small $1 withdrawal fee
                    ...
                    <div class="hs-accordion border-2 border-[#26252a]"
                        ...
                        <button
                            ...
                            How does Txwai benefit or make profit?
                            <svg class="hs-accordion-active:hidden block size-4" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div id="hs-basic-with-title-and-arrow-stretched-collapse-12"
                            class="pb-4 px-5 pt-4 hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
                            role="region" aria-labelledby="hs-basic-with-title-and-arrow-stretched-heading-three">
                            <p class="text-white text-sm">
                    ...
                    <div class="hs-accordion border-2 border-[#26252a]"
                        ...
                        <button
                            ...
                            Does Txwai increase my returns daily?
                            <svg class="hs-accordion-active:hidden block size-4" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                    ...
                    <div class="hs-accordion border-2 border-[#26252a]"
                        ...
                        <div id="hs-basic-with-title-and-arrow-stretched-collapse-seven"
                            class="pb-4 px-5 pt-4 hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
                    ...
                    <div class="hs-accordion border-2 border-[#26252a]"
                        ...
                        <div id="hs-basic-with-title-and-arrow-stretched-collapse-eight"
                            class="pb-4 px-5 pt-4 hs-accordion-content hidden w-full overflow-hidden transition-[height] duration-300"
