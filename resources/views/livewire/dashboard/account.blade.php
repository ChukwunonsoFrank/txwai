                            ...
                            {{-- <div class="flex items-start gap-x-1 mb-3">
                                ...
                                <div class="flex-1">
                                    <input id="uid" type="text" class="hidden"
                                        value="{{ 'https://txwai.com/register?ref=' . auth()->user()->referral_code }}">
                                    <p class="text-[10px] text-[#a4a4a4]">
                                        {{ 'https://txwai.com/register?ref=' . auth()->user()->referral_code }}</p>
                                </div>
                ...
                <div class="mb-3 grid grid-cols-1 gap-1 lg:grid-cols-2 lg:gap-2 lg:mb-2">
                    ...
                    <a href="{{ route('dashboard.connectedexchanges') }}">
                        <div
                            ...
                            <div class="flex-none -mt-0.5 text-end"><img class="inline w-14 align-middle"
                                    src="{{ asset('assets/icons/binance.svg') }}" alt="binance-logo"> <img
                                ...
                                <div class="flex flex-col gap-y-1">
                                    <div>
                                        <label for="file-upload"
                                            class="inline-flex items-center gap-x-1 bg-[#1F4ED8] text-black text-xs p-2 rounded-lg cursor-pointer">
                                            <div class="-mt-0.5">
            ...
            <div x-cloak x-show="$store.accountPage.isSupportModalOpen" x-transition
                ...
                <div class="grow">
                    <iframe frameborder="0" width="100%" height="100%"
                        src="https://tawk.to/chat/69a15fb66358061c35fc82f1/1jif5rol4"></iframe>
                </div>
            </div>
        </div>
    </div>
