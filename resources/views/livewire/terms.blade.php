<div class="px-4">
    <div class="mx-auto px-4 lg:px-28">
        ...
        <p class="font-medium text-md text-white">Txwai is a bot that was created for automated trading on the
            Txwai platform. To use the Site and the App, you must agree to the below terms, so please read them
            carefully.</p>
        ...
        <p class="font-medium text-md text-white mb-4"><b>1.1</b> These Terms and Conditions (the Terms) govern the
            use of certain services, including accessing the website txwai.com with all its subpages, related
        ...
        <p class="font-medium text-md text-white mb-4"><b>2.1</b> By using or accessing the Services, you agree to
            ...
            conditions in addition to those in these Terms.</p>

        <p class="font-medium text-md text-white"><b>2.2</b> The Company grants you a non-exclusive, non-transferable
            and limited personal license to access and use the Site and the App. This license is conditional upon your
        ...
        <p class="font-medium text-md text-white mb-4"><b>4.2</b> It is your responsibility to check the Terms from
            time to time during your use of the Services. If you do not accept the modified version of the Terms, you
            shall immediately cease using the Services.</p>

        <p class="font-medium text-md text-white"><b>4.3</b> We may terminate these Terms and your access to all or
        ...
        <p class="font-medium text-md text-white mb-4"><b>5.2</b> We reserve the right to suspend of prohibit your
            use of the Services at any time if we have reasons to believe that you have, may, or intended to violate the
            Terms.</p>

        <p class="font-medium text-md text-white mb-4"><b>5.3</b> We reserve the right at any time to modify, suspend
            or discontinue any part of the Services with or without notice. You agree that we shall not be liable to you
            or to any third party for any such modification, suspension or discontinuance. We also reserve the right at
            any time in our sole discretion to block users from certain Ipaddresses.</p>

        <p class="font-medium text-md text-white mb-4"><b>5.4</b> While we welcome any feedback or comments from you,
            please note that any unsolicited ideas, feedback or suggestions pertaining to our business, such as
            proposals for new or improved products or technologies, website or tool enhancements, processes, materials,
            marketing plans or new product names you transfer irrevocably, royalty-free, worldwide and exclusively all
            the proprietary rights for listed items to the Company upon submission. You waive moral rights for the
            listed items and your right for any compensation and the rights to forbid, allow, restrict or otherwise by
            any method influence or obstruct the Company to use or enjoy its rights in the listed above items.</p>

        <p class="font-medium text-md text-white"><b>5.5</b> The Services may contain links to third party services
            that are not owned or controlled by the Company. The Company has no control over and assumes no
            responsibility for the content, privacy policies, or practices of any third-party services. In addition, the
            Company will not and cannot censor or edit the content of any third-party service. You gain access to and
            use the services, products or third-party sites at your own discretion and risk, and you will be solely
            responsible for any damage to your computer system or mobile device for loss of data resulting therefrom.
            You expressly release the Company from any and all liability, claims and damages both known and unknown
        ...
        <p class="font-medium text-md text-white mb-4"><b>6.2</b> We are not obligated to maintain or support any of
            the Services, to provide all or any specific content of the Services, or to provide you with updates,
            upgrades or services related thereto. You acknowledge that we may from time to time in our sole discretion
            make updates or upgrades to any of the Services, disable access for any period of time or permanently, and
            automatically update or upgrade the version of any of the Services that you are using. You consent to such
            automatic updating or upgrading and agree that these Terms will apply to all such updates or upgrades,
            unless such upgrade is accompanied by a separate license, in which case the terms of that license will
            govern.</p>

        <p class="font-medium text-md text-white mb-4"><b>6.3</b> The Services and all content, functions, and
            materials made available to you are provided “as is” or “as available,” without warranty of any kind, either
            express or implied, including, without limitation, any warranties of title, non-infringement,
            merchantability or fitness for a particular purpose.</p>

        <p class="font-medium text-md text-white mb-4"><b>6.4</b> Neither the Company nor its current or future
            affiliates, subsidiaries, nor its or their officers, directors, employees or agents (collectively, the
            Affiliated Parties) warrant that any of the foregoing will be timely, secure, uninterrupted or error-free,
            or that defects will be corrected. None of the Affiliated Parties shall be liable for any damage to, or
            viruses that may infect your computer equipment or other property on account of your access to or use of any
            of the foregoing.</p>

        <p class="font-medium text-md text-white mb-4"><b>6.5</b> The Site allows you to access the information
        ...
        <p class="font-medium text-md text-white mb-4"><b>6.7</b> All information provided to you through Services is
            ...
            information may be reproduced, distributed, transmitted, or otherwise made available without our prior
            consent. Any unauthorized disclosure is strictly prohibited. The Company reserves its right to claim damages
            from you, including any loss of profits, for your unauthorized use of such information.</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8</b> By accessing and using the Services, you hereby
            agree that:</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.1</b> You will not use the Services for any unlawful
            purpose;</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.2</b> you will not upload, post, email, transmit, or
            otherwise make available any content that:</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.2.1</b> infringes any copyright, trademark, right of
            publicity, or other proprietary rights of any person or entity;</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.2.2</b> is threatening, tortious, defamatory, libelous,
            indecent, obscene, pornographic, sexually explicit, invasive of another’s privacy, or promotes extreme
            violence or cruelty to animals, or contains hate speech (i.e., speech that attacks or demeans a groupbased
            on race or ethnic origin, religion, disability, gender, age, veteran status, or sexual orientation/gender
            identity);</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.2.3</b> discloses any sensitive information about
        ...
        <p class="font-medium text-md text-white mb-4"><b>6.8.3</b> you will not “stalk” or otherwise harass another
            person;</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.4</b> you will not spam or use the Services to engage
            in any commercial activities;</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.5</b> you will not access or use the Services to
            collect any market research for a competing business;</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.6</b> you will not impersonate any person or entity;
        </p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.7</b> you will not interfere with or attempt to
            interrupt the proper operation of the Services through the use of any virus, device, information collection
            or transmission mechanism, software or routine, or access or attempt to gain access to any data, files, or
            passwords related to the Services through hacking, password or data mining, or any other means;</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.8</b> you will not use any robot or other automated
            means to access the Services for any purpose without our express written permission; provided, however, we
            grant the operators of public search engines permission to use spiders to copy materials from the public
            portions of the Services for the sole purpose of and solely to the extent necessary for creating
            publicly-available searchable indices of the materials, but not caches or archives of such materials;</p>

        <p class="font-medium text-md text-white mb-4"><b>6.8.9</b> you will not take any action that imposes or may
            impose (as determined in our sole discretion) an unreasonable or disproportionately large load on our
